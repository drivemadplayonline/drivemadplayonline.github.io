window.addEventListener("load", (event) => {
    ...
    function loadGoogleAdsense() {
        ...
        j.src= "https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-5152482106464455";
    ...
    if (botBrowser()) {
        ...
        if (window.location.href.indexOf("/drivemadplayonline.github.io")> -1) {
            if (inFrame()) {
            ...
            console.log("Adsense Skip! Not Classroom 6x!");
        }
    }
});
