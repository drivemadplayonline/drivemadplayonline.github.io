...
def replace_in_file(file_path):
    ...
    try:
        ...
        old_text = """Play unblocked games on Classroom 6x instantly in fullscreen browser, no downloads, no ads. Explore and enjoy various gaming experiences now!"""
        new_text = """Experience the ultimate gaming destination at Drive Mad Play Online! Play unblocked games online for free—no downloads, no ads, just seamless fun. Enjoy top-rated games instantly in fullscreen mode and explore a variety of exciting genres. Start playing now!"""
